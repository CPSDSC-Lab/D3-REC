...
DATA_ROOT = '/root/autodl-tmp/data/rec-8k/' 
class DataProcessor(): 
    def __init__(self):
        self.image_path = DATA_ROOT

        self.anno_file = '/root/autodl-tmp/data/rec-8k/annotations.json'
        self.annotations = self.read_annotations()
    
        self.split_file = '/root/autodl-tmp/data/rec-8k/splits.json'
